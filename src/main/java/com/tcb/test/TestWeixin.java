...
import com.github.sd4324530.fastweixin.TestConfigChangeHandle;
import com.github.sd4324530.fastweixin.api.CustomAPI;
import com.github.sd4324530.fastweixin.api.DataCubeAPI;
...
public class TestWeixin {
	private static final Logger LOG = LoggerFactory.getLogger(TestWeixin.class);
...
//	    @Test
	...
	public void testtcb() {
        ...
        main1.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx7139ab62847dfb68&redirect_uri=http://www.sino-sources.com/tcb&response_type=code&scope=snsapi_base&state=AAABBBCCCDDDEEEFFFGGG#wechat_redirect");
        ...
        sub11.setKey("productnew");
        sub11.setName("最新产品");
        sub11.setType(MenuType.VIEW);
        sub11.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx7139ab62847dfb68&redirect_uri=http://www.sino-sources.com/tcb/myaccount&response_type=code&scope=snsapi_base&state=menu#wechat_redirect");
        
        List<MenuButton> list1 = new ArrayList<MenuButton>();
        list1.add(sub11);
        
        //将子菜单放入主菜单里
        main2.setSubButton(list1);
      ...
      //准备一级主菜单
        ...
        main3.setName("我的");
        //准备子菜单
        MenuButton sub111 = new MenuButton();
        sub111.setKey("myinfo");
        sub111.setName("我的账户");
        sub111.setType(MenuType.VIEW);
        sub111.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx7139ab62847dfb68&redirect_uri=http://www.sino-sources.com/tcb/&response_type=code&scope=snsapi_base&state=menu#wechat_redirect");
        MenuButton sub211 = new MenuButton();
        sub211.setKey("myservice");
        sub211.setName("送红包");
        sub211.setType(MenuType.VIEW);
        sub211.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx7139ab62847dfb68&redirect_uri=http://www.sino-sources.com/tcb/&response_type=code&scope=snsapi_base&state=menu#wechat_redirect");
        MenuButton sub311 = new MenuButton();
        sub311.setKey("yijianfankui");
        sub311.setName("邀请好友");
        sub311.setType(MenuType.VIEW);
        sub311.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx7139ab62847dfb68&redirect_uri=http://www.sino-sources.com/tcb/&response_type=code&scope=snsapi_base&state=menu#wechat_redirect");

        List<MenuButton> list11 = new ArrayList<MenuButton>();
        list11.add(sub111);
        list11.add(sub211);
        list11.add(sub311);
        //将子菜单放入主菜单里
        main3.setSubButton(list11);
	...
	public static void main(String[] args) {
		TestWeixin test = new TestWeixin();
		test.testtcb();
