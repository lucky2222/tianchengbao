...
@Service(value = "ResultByPageService")
public class ResultByPageService
{
	...
	public DataRow getParamByRequest(HttpServletRequest request)
	{
		...
		if (onlinestaff != null)
		{
			...
			param.put("updatestaff", ((DataRow) onlinestaff).getString("staffid"));
			param.put("updatestaffname", ((DataRow) onlinestaff).getString("staffname"));
			if (((DataRow) onlinestaff).containsKey("hostid"))
			{
				param.put("hostid", ((DataRow) onlinestaff).getString("hostid"));
			}
		}
		return param;
	}
	...
	public void InitCommonParam(HttpServletRequest request, DataRow param)
	{
		...
		if (onlinestaff != null)
		{
			param.put("updatestaffid", ((DataRow) onlinestaff).getString("staffid"));
			param.put("updatestaffname", ((DataRow) onlinestaff).getString("staffname"));
			if (((DataRow) onlinestaff).containsKey("hostid"))
			{
				param.put("hostid", ((DataRow) onlinestaff).getString("hostid"));
