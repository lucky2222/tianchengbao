	...
	<body>
        ...
        <ul class="mui-table-view">
			<li class="mui-table-view-cell mui-collapse mui-active">
				<a class="mui-navigate-right" href="#">Income Detail</a>
				<div class="mui-collapse-content">
					<ul id="downlist" class="mui-table-view">
						<c:forEach var="item" items="${incomeList}"  varStatus="flag">
							<li class="mui-table-view-cell">Contract No:${item.ID}</li>
							<li class="mui-table-view-cell">Date:${item.Created}</li>
							<li class="mui-table-view-cell">AmountExpected:${item.AmountExpected}</li>
						</c:forEach>
