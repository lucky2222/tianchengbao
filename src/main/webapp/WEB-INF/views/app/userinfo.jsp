	...
	<body>
        ...
        <ul class="mui-table-view">
			<li class="mui-table-view-cell mui-collapse mui-active">
				<a class="mui-navigate-right" href="#">Summary</a>
				<div class="mui-collapse-content">
					<ul class="mui-table-view">
						<li class="mui-table-view-cell">email:${user_info.email}</li>
						<li class="mui-table-view-cell">telno:${user_info.tel}</li>
						<li class="mui-table-view-cell">first_name:${user_info.first_name}</li>
						<li class="mui-table-view-cell">last_name:${user_info.last_name}</li>
						<li class="mui-table-view-cell">company:${user_info.company}</li>
						<li class="mui-table-view-cell">addr:${user_info.street_address}</li>
						<li class="mui-table-view-cell">&nbsp;<a href="http://www.sino-sources.com/app/logout" class="mui-btn mui-btn-primary" >Logout</a></li>
