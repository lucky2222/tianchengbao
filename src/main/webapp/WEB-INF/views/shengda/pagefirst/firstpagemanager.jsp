...
<ehang:Main>
	...
	<c:forEach var="item" items="${resultList}"  varStatus="flag">
      		<tr>
      			...
      			<td><nobr>${item.object_id}</nobr></td>
      			<td><nobr>${item.title}</nobr></td>
      			<td><nobr>
...
<div class="modal fade" id="xiugaiplan">
  ...
  <form action="/main/domodifySDproduct" method="post">
    <div class="modal-content">
      ...
      <div class="modal-body">
			 ...
			 <div class="form-group">
			    <label for="product_price">绑定对象编码</label>
			    <input type="text" class="form-control" id="id" name="object_id" placeholder="object_id" value=""/>
			  </div>
      </div>
