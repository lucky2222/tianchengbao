...
<ehang:Main>
	...
	<link rel="stylesheet"
		href="${pageContext.request.contextPath}/resources/bootstrap/css/bootstrap-3.0.3.min.css">
	<link rel="stylesheet"
		href="${pageContext.request.contextPath}/resources/bootstrap/css/bootstrap-multiselect.css"
		type="text/css">

<!-- 	<script type="text/javascript" src="js/jquery-2.0.3.min.js"></script> -->
<!-- 	<script type="text/javascript" src="js/bootstrap-3.0.3.min.js"></script> -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/bootstrap/js/bootstrap-multiselect.js"></script>
		...
		<table class="table table-striped table-hover">
			<tbody>
				<tr id="test-build-tr" class="success">
					<th>Test build</th>
					<td><select id="test-build-select" multiple="multiple">
				...
				<tr id="test-build-optgroups-tr" class="success">
					...
					<td><select id="test-build-optgroups-select"
						multiple="multiple">
							<optgroup label="1,2">
				...
				<tr id="test-build-selected-tr" class="success">
					...
					<td><select id="test-build-selected-select"
						multiple="multiple">
							<option value="1" selected="selected">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
				...
				<tr id="test-build-select-all-tr" class="success">
					...
					<td><select id="test-build-select-all-select"
						multiple="multiple">
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
				...
				<tr id="test-build-filter-tr" class="success">
					...
					<td><select id="test-build-filter-select" multiple="multiple">
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
							<option value="4">4</option>
				...
				<tr id="test-select-tr" class="success">
					<th>Test select</th>
					<td><select id="test-select-select" multiple="multiple">
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
							<option value="4">4</option>
				...
				<tr id="test-deselect-tr" class="success">
					<th>Test deselect</th>
					<td><select id="test-deselect-select" multiple="multiple">
							<option value="1" selected="selected">1</option>
				...
				<tr id="test-max-height-tr" class="success">
					...
					<td><select id="test-max-height-select" multiple="multiple">
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
							<option value="4">4</option>
		...
		$(document).ready(
				function()
				{
					...
					var select = function(selectElement, tr)
					{
						...
						var second = $('option:selected', selectElement).get(1), third = $('option:selected',
								selectElement).get(2);
