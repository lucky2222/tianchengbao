...
$(function(){
	$.fn.extend({
		SimpleTree:function(options){
			...
			/* 设置所有超链接不响应单击事件 */
			this.find("span").click(function(){ $(this).parents("li").click(); return false; });
			...
			this.find("li").click(function(){
				 ...
				 * 3.重新初始化菜单
				 */
				var a=$(this).find("span")[0];
				if(typeof(span)!="undefined")
					option.click(span);	/* 如果获取的超链接不是 undefined，则触发单击 */
			...
			/* 设置节点“是否包含子节点”属性 */
			this.find("li").find("span").attr("hasChild",false);
