...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>拖拽或下拉选择</b></span>",
            abortStr: "中止",
            cancelStr: "取消",
            deletelStr: "删除",
            doneStr: "完成",
            multiDragErrorStr: "多文件拖拽文件 &amp; 不允许下拉.",
            extErrorStr: "不允许.允许的扩张名: ",
            duplicateErrorStr: "不允许.文件已存在.",
            sizeErrorStr: "不允许上传,最大上传文件大小: ",
            uploadErrorStr: "不允许上传",
            maxFileCountErrorStr: " 不允许上传. 文件数最大不能超过:",
            downloadStr: "下载",
