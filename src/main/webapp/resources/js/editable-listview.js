...
(function ($, undefined) {
    ...
    $.widget("mobile.listview", $.mobile.listview, {
        ...
        _beforeListviewRefresh: function () {
        	...
        	var isload = this.element.attr('load');
        	if(url != null && url != '' && isload == 'true')
        	{
        		ajax_ul_init(this.element, url, '');
        		this.element.attr('load',false);
        	}
        	}
...
//                this.option("splitIcon", "minus");
                ...
                if (opts.editableType === 'complex') {
                    ...
                    var first_li_edit = $orig.children().eq(0);
                    var inputs = first_li_edit.find('input[class="datepicker"]');
                    inputs.datepicker({
                    	dateFormat : "yy-mm-dd"
                    });
                }
        ...
        _insertListItem: function (e) {
            ...
            if (this.options.editableType === 'complex') {
                ...
                this._onEditButtonTapped(e);
                this._updateHeader(e);
                var $collapsible = this.element.parents(":jqmData(role='collapsible')");
